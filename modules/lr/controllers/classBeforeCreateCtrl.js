mj.controller("classBeforeCreateCtrl", function ($http, $scope, $state,
                                                 handleData) {
    $(function () {
        $('.modal').modal();
    });

    var idGroupUrl = "../group/dataList";
    var resourceUrl = "../tr/resource/";
    var isClick = [];

    //页面加载完成之后加载数据
    $scope.loadAllData = function () {
        var promise = handleData.loadData("get", resourceUrl + "datalist");
